*** Settings ***
Resource    ../StepDefinitions/HighTempAlarmStepDef.robot

*** Test Cases ***
HighTempAlarmTest
    Given Set High temp alarm limit 25.0 deg-SVB5
    And Set Alarm Delay 0-SVB5
    When set Thermostart air of AK CC 550 controller to 30.0 deg-MCX A0
    ...
    When set Thermostart ait of AK CC 550 controller to 20.0 deg-MCX A0
