...
*** Keywords ***
Set High temp alarm limit 25.0 deg-SVB5
    LogintoSVB5 and Select device AK-CC550-018x 20  Supervisor  S@danfoss123
    Set High Temp in SVB5    25.0

Set High Temp in SVB5
    [Arguments]     ${tempvalueinsvb5}
    double click element    xpath://td[contains(text(),'25.0 °C')]
...
set Thermostart air of AK CC 550 controller to 30.0 deg-MCX A0
...
SVB5 active alarm page should be present with High Temp Alarm
    ...
    click on device name of apeared alarm     AK-CC550-018x 20    --- High Temp Alarm
    assertion on appered alarm      --- High Temp Alarm      AK-CC550-018x 20   20      Alarm if error      Normal      1
...
set Thermostart ait of AK CC 550 controller to 20.0 deg-MCX A0
    switch browser      2
